/******************************************************************************
*
* Register Bit Structured header file for EPWM
*
...
struct TZOSTFLG_BITS {                  // bits description
    ...
    Uint16 DCAEVT2:1;                   // 6 Latched Status Flag for Digital Compare Output A Event 1
    Uint16 DCBEVT2:1;                   // 7 Latched Status Flag for Digital Compare Output B Event 1
    Uint16 rsvd1:8;                     // 15:8 Reserved
};
...
struct TZOSTCLR_BITS {                  // bits description
    ...
    Uint16 DCAEVT2:1;                   // 6 Clear Flag for DCAEVT1 selected for OST
    Uint16 DCBEVT2:1;                   // 7 Clear Flag for DCBEVT1 selected for OST
    Uint16 rsvd1:8;                     // 15:8 Reserved
};
...
struct DCAHTRIPSEL_BITS {               // bits description
    ...
    Uint16 TRIPINPUT13:1;               // 12 Trip Input 13 Select to DCAH Mux
...
struct DCALTRIPSEL_BITS {               // bits description
    ...
    Uint16 TRIPINPUT13:1;               // 12 Trip Input 13 Select to DCAL Mux
...
struct DCBHTRIPSEL_BITS {               // bits description
    ...
    Uint16 TRIPINPUT13:1;               // 12 Trip Input 13 Select to DCBH Mux
...
struct DCBLTRIPSEL_BITS {               // bits description
    ...
    Uint16 TRIPINPUT13:1;               // 12 Trip Input 13 Select to DCBL Mux
