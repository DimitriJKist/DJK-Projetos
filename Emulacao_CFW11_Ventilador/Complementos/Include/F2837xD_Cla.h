/******************************************************************************
*
* Register Bit Structured header file for CLA
*
...
struct CLA_REGS {
    ...
    Uint32                                   _MR0;                         // CLA Floating-Point Result Register 0
    Uint16                                   rsvd5[2];                     // Reserved
    Uint32                                   _MR1;                         // CLA Floating-Point Result Register 1
    Uint16                                   rsvd6[2];                     // Reserved
    Uint32                                   _MR2;                         // CLA Floating-Point Result Register 2
    Uint16                                   rsvd7[2];                     // Reserved
    Uint32                                   _MR3;                         // CLA Floating-Point Result Register 3
};
