/******************************************************************************
*
* Register Bit Structured header file for SYSCTRL
*
...
struct PARTIDL_BITS {                   // bits description
    Uint16 TEMPERATURE:3;               // 2:0 Temperature Rating
    Uint16 PACKAGE:2;                   // 4:3 Device Package
...
struct PARTIDH_BITS {                   // bits description
    Uint16 PARTID_FORMAT_REVISION:4;    // 3:0 Revision of the PARTID format
...
struct SOFTPRES5_BITS {                 // bits description
    Uint16 rsvd1:1;                     // 0 Reserved
    Uint16 rsvd2:1;                     // 1 Reserved
    Uint16 rsvd3:1;                     // 2 Reserved
    Uint16 rsvd4:1;                     // 3 Reserved
...
struct DEV_CFG_REGS {
    ...
    union   DC18_REG                         DC18;                         // Device Capability: Lx.1 SRAM Customization
    union   DC19_REG                         DC19;                         // Device Capability: Lx.2 SRAM Customization
    ...
    union   SOFTPRES5_REG                    SOFTPRES5;                    // Peripheral Software Reset register
...
struct WDCR_BITS {                      // bits description
    ...
    Uint16 WDFLG:1;                     // 7 WD Reset Status Flag
    Uint16 rsvd1:8;                     // 15:8 Reserved
};
