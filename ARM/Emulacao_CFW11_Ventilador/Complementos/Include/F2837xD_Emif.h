/******************************************************************************
*
* Register Bit Structured header file for EMIF
*
...
struct IO_CTRL_BITS {                   // bits description
...
struct IO_STAT_BITS {                   // bits description
...
struct MODEL_REL_NUM_BITS {             // bits description
