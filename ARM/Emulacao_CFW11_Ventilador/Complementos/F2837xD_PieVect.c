//###########################################################################
//
// FILE:   F2837x_PieVect.c
//
// TITLE:  F2837x Device PIE Vector Initialization Functions
//
//###########################################################################
...
const struct PIE_VECT_TABLE PieVectTableInit = {
    ...
    DCANA_1_ISR,                                      // 9.5 - DCANA Interrupt 1 
    DCANA_2_ISR,                                      // 9.6 - DCANA Interrupt 2 
    DCANB_1_ISR,                                      // 9.7 - DCANB Interrupt 1 
    DCANB_2_ISR,                                      // 9.8 - DCANB Interrupt 2 
    ...
    PBIST_ISR,                                        // 12.4 - PBIST Interrupt 
    ...
    IPC0_ISR,                                         // 1.13 - IPC Interrupt 1
    IPC1_ISR,                                         // 1.14 - IPC Interrupt 2
    IPC2_ISR,                                         // 1.15 - IPC Interrupt 3
    IPC3_ISR,                                         // 1.16 - IPC Interrupt 4
